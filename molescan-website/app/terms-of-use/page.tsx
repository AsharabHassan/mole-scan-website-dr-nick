...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "MoleScan website terms of use. Information regarding intellectual property, site rules, and disclaimers.",
};
    ...
    <>
      ...
      <SectionWrapper background="white">
        <article className="prose prose-lg max-w-3xl mx-auto">
          ...
          <h2>RELIANCE ON INFORMATION AND LINKS</h2>
          <p>
          ...
          <p>Copyright © 2026 Dermme Health Ltd, Trading as MoleScan.</p>
          <p>
          ...
          <p>
            The information contained above is provided for information purposes only. The contents on this website are not intended to amount to advice and you should not rely on any of the contents of this website. Professional advice should be obtained before taking or refraining from taking any action as a result of the contents of this Website. Dermme Health Ltd, Trading as MoleScan disclaims all liability and responsibility arising from any reliance placed on any of the contents of this Website.
          </p>
        </article>
      </SectionWrapper>
    </>
