...
const DESCRIPTION =
  "Why skin cancer referrals continue to rise — and why structured triage matters more than ever. A look at a decade of NHS England 2WW dermatology data and the case for structured lesion assessment before referral.";
      ...
      <article className="bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14 text-brand-text/85 text-[17px] leading-[1.75]">
          ...
          <p className="mb-5">
            ...
            services. In dermatology, the pathway plays a critical role in
          ...
          <p className="mb-5">
            At the same time, the conversion rate — the percentage of urgent
            referrals that ultimately result in a cancer diagnosis — has
            gradually fallen. NHS England data shows conversion rates
          ...
          <p className="mb-5">
            The variation across England is also significant. For the financial
            year ending March 2023, NHS data demonstrated wide variation
            between sub-ICB regions:
          </p>

          <ul className="mb-5 pl-5 list-disc marker:text-brand-teal space-y-1.5">
            <li>Referral rates ranged from 434 to 2,506 per 100,000 population</li>
            <li>Conversion rates ranged from 2.4% to 11.9%</li>
            <li>Detection rates ranged from 40% to 84%</li>
          </ul>
          ...
          <ul className="mb-5 pl-5 list-disc marker:text-brand-teal space-y-1.5">
            <li>18,624 urgent suspected skin cancer referrals were made</li>
            <li>852 cancers were detected</li>
            <li>The overall conversion rate was 4.6%</li>
          </ul>
          ...
          <p className="mb-5">
            ...
            creates substantial pressure. The answer is not reducing referrals,
            nor increasing thresholds unsafely. The answer is{" "}
            <span className="font-semibold text-brand-deep-navy">
